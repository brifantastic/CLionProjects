...
int main(int argc, char** argv) {
    ...
    cout << "Address of myRestaurants[0] in main:  " << myRestaurants[0] << endl;
...
Restaurant* getFavorite(vector<Restaurant*>* myRestaurants) {
    ...
    for (int i = 0; i<myRestaurants->size(); i++) {
        (*myRestaurants->at(i)).Print();
        if ((*myRestaurants->at(i)).GetRating() > maxRating) {
            maxRatingIndex = i;
            maxRating = (*myRestaurants->at(i)).GetRating();
        }
    }
    cout << "Max rating index:  " << maxRatingIndex << endl;
    cout << "Max rating:  " << maxRating << endl;
    cout << endl;
    ...
    bestRestaurant = &(*myRestaurants->at(maxRatingIndex));
    cout << "Address of bestRestaurant in getFavorite:  " << bestRestaurant << endl;
    cout << "Address of myRestaurants[maxRatingIndex] in getFavorite:  " << &(*myRestaurants->at(maxRatingIndex)) << endl;
